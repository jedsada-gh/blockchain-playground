...
class Blockchain:
    ...
    def get_previous_has_block(self):
        return self.chain[-1]
    ...
    def add_transaction(self, sender, receiver, amount):
        ...
        previous_block = self.get_previous_has_block()
...
def mine_block():
    previous_block = blockchain.get_previous_has_block()
    previous_proof = previous_block['proof']
    proof = blockchain.proof_of_work(previous_proof)
    previous_hash = blockchain.hash(previous_block)
    blockchain.add_transaction(sender = node_address, receiver = 'Jedsada', amount = 1)
...
# Replacing the chain byt he longest chain if new needed
